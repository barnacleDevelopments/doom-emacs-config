...
Copy a friendly review request message with PR details to the kill ring. Randomly selects
from a pool of greeting variations so repeated requests don't feel copy-pasted. Uses the
same PR metadata and Jira extraction as the deployment copy function.
